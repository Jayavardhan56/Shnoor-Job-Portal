...
import {FaFacebook,FaTwitter,FaLinkedin, FaWhatsapp, FaMailBulk} from "react-icons/fa";

export default function Footer(){
  return(
    <footer className="bg-[#f0fdfa] border-t border-teal-100 pt-32 pb-16">
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-24">
          <div className="space-y-10">
            <div className="flex items-center gap-4">
              <img src={logo} alt="Shnoor" className="h-10 w-auto"/>
              <span className="text-3xl font-black text-slate-800 tracking-tighter">Shnoor</span>
            </div>
            <p className="text-slate-500 text-lg leading-relaxed font-medium">Empowering the next generation of global talent through high-performance AI recruitment and career intelligence.</p>
          ...
          <div className="bg-white p-10 rounded-[40px] shadow-2xl shadow-teal-500/5 border border-teal-50">
            ...
            <div className="space-y-4">
              <input type="email" placeholder="work@company.com" className="w-full bg-[#f8fafc] border border-slate-100 p-5 rounded-2xl text-sm outline-none focus:border-teal-500 transition-all font-medium"/>
              <button className="w-full bg-primary text-white py-5 rounded-2xl text-xs font-bold uppercase tracking-[3px] hover:bg-secondary transition-all shadow-lg active:scale-95">Subscribe</button>
            </div>
          </div>
        </div>
