    ...
    <AdminLayout>
      <div className="max-w-7xl mx-auto font-plus bg-white min-h-screen p-12">
        ...
        <div className="space-y-2">
          <div className="grid grid-cols-[70px_1fr_1.5fr_1fr] px-6 py-3 text-xs font-bold text-slate-400 uppercase tracking-[2px]">
          ...
          <div className="divide-y divide-slate-100">
            ...
            {filtered.map(u=>(
              <div key={u.id} className={`grid grid-cols-[70px_1fr_1.5fr_1fr] items-center py-8 px-6 hover:bg-slate-50/50 transition-all group ${selected.includes(u.id) ? 'bg-teal-50/30' : ''}`}>
                <div className="flex justify-center">
                  <input 
                    type="checkbox" 
